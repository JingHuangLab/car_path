...
def exec_cos(chain: ChainCart, atom_names, work_dir: str):
    ...
    opt = ConsGradientDescent(cos, gd_eta=0.0001 if 'rxn17' in work_dir else 0.0002, gd_eta_scal=.98, fix_mode='both')
    convergence_criteria = 0.007 if 'rxn17' in work_dir else 0.0001
